...
public class WiFiStartNetworkCommandEvent extends CommandEvent {
    private static final String TAG =  "WiFiStartNetworkEvent";

    public String networkName;
    public String passphrase;
    public int channelIndex;

    public WiFiStartNetworkCommandEvent() {
    }
